...
(define tests
  (test-suite
   ...
   (check-equal? (sequence 3 1 1) (list)) 
   ...
   ; list-nth-mod test
   (check-exn exn:fail? (lambda () (list-nth-mod (list 1) -1)))
   (check-exn exn:fail? (lambda () (list-nth-mod null 1)))
   (check-equal? (list-nth-mod (list 1) 0) 1)
   (check-equal? (list-nth-mod (list 0 1) 0) 0)
   ...
   (check-equal? (stream-for-n-steps funny-number-stream 5) (list 1 2 3 4 -5))
   ...
   (check-equal? (stream-for-n-steps dan-then-dog 2) (list "dan.jpg" "dog.jpg"))
